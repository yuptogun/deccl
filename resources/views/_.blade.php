...
@endif
    ...
    <link href="{{ url('fonts/free-sans/FreeSans.css') }}" rel="stylesheet">
    <link rel="stylesheet" href="{{ mix('css/deccl.css') }}">
    @stack('styles')
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-4T0SG4BP8M"></script>
    <script>window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-4T0SG4BP8M');</script>
    @stack('scripts')
    @stack('head_after')
</head>
<body>
